...
function AccountPageComponent(props: { element: AccountPageWebapp }) {
...
export class AccountPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(AccountPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestAccountPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new AccountPageWebapp(model);
    }
}
