...
function AccountNavigationLinkComponent(props: { element: TestAccountNavigationLink }) {
...
export class TestAccountNavigationLink extends BaseReactUiElement {
    constructor(model: any) {
        super([], ['title', 'visible'], [], ['click'], model);
    }
    ...
    isVisible() {
        return this.state.get('visible') as boolean;
    }

    createReactElement(): React.ReactElement {
        return React.createElement(AccountNavigationLinkComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestAccountNavigationLinkFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new TestAccountNavigationLink(model);
    }
}
