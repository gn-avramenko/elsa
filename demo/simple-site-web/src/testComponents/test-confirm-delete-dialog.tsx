...
function ConfirmDeleteDialogComponent(props: { element: ConfirmDeleteDialogWebapp }) {
    ...
    return (
        ...
        >
            ...
            >
                {props.element.findByTag('text').createReactElement()}
            </div>
            <DetailsModal
...
export class ConfirmDeleteDialogWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(ConfirmDeleteDialogComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestConfirmDeleteDialogFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new ConfirmDeleteDialogWebapp(model);
    }
}
