...
function HistoryPageComponent(props: { element: HistoryPageWebapp }) {
...
export class HistoryPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(HistoryPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestHistoryPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new HistoryPageWebapp(model);
    }
}
