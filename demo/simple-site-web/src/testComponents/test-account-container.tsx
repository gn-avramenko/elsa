...
function AccountContainerComponent(props: { element: AccountContainerWebapp }) {
...
export class AccountContainerWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(AccountContainerComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestAccountContainerFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new AccountContainerWebapp(model);
    }
}
