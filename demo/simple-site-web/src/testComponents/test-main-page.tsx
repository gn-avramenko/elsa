...
function MainPageComponent(props: { element: MainPageWebapp }) {
    ...
    return (
        ...
        >
            ...
            >
                {props.element.findByTag('measurementsChart').createReactElement()}
            </div>
            <DetailsModal
...
export class MainPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(MainPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestMainPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new MainPageWebapp(model);
    }
}
