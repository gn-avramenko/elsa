...
function TestNavigationPanelComponent(props: { element: TestNavigationPanel }) {
    ...
    return (
        ...
        >
            ...
            >
                {props.element.findByTag('historyLink').createReactElement()}
                {props.element.findByTag('mainLink').createReactElement()}
                {props.element.findByTag('accountLink').createReactElement()}
                {props.element.findByTag('languageSelector').createReactElement()}
            </div>
            <DetailsModal
...
export class TestNavigationPanel extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(TestNavigationPanelComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestNavigationPanelFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new TestNavigationPanel(model);
    }
}
