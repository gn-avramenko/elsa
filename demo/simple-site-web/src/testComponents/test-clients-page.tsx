...
function ClientsPageComponent(props: { element: ClientsPageWebapp }) {
...
export class ClientsPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(ClientsPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestClientsPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new ClientsPageWebapp(model);
    }
}
