...
function AccountLinkComponent(props: { element: TestAccountLink }) {
...
export class TestAccountLink extends BaseReactUiElement {
    constructor(model: any) {
        super([], ['title', 'insideAccountSection', 'loggedIn'], [], ['click'], model);
    }
    ...
    isInsideAccountSection() {
        return this.state.get('insideAccountSection') as boolean;
    }
    isLoggedIn() {
        return this.state.get('loggedIn') as boolean;
    }

    createReactElement(): React.ReactElement {
        return React.createElement(AccountLinkComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestAccountLinkFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new TestAccountLink(model);
    }
}
