...
function SecurityPageComponent(props: { element: SecurityPageWebapp }) {
...
export class SecurityPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(SecurityPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestSecurityPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new SecurityPageWebapp(model);
    }
}
