...
function DoctorsPageComponent(props: { element: DoctorsPageWebapp }) {
...
export class DoctorsPageWebapp extends BaseReactUiElement {
    ...
    createReactElement(): React.ReactElement {
        return React.createElement(DoctorsPageComponent, {
            element: this,
            key: this.id,
        });
    }
...
export class TestDoctorsPageFactory implements ReactUiElementFactory {
    createElement(model: any): BaseReactUiElement {
        return new DoctorsPageWebapp(model);
    }
}
