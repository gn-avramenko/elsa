...
import { AccountPageSkeleton } from '@g/account/AccountPageSkeleton';

function AccountPageFC(props: { element: AccountPageComponent }) {
...
export class AccountPageComponent extends AccountPageSkeleton {
    functionalComponent = AccountPageFC;
