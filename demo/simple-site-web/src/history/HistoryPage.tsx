...
import { HistoryPageSkeleton } from '@g/history/HistoryPageSkeleton';

function HistoryPageFC(props: { element: HistoryPageComponent }) {
...
export class HistoryPageComponent extends HistoryPageSkeleton {
    functionalComponent = HistoryPageFC;
