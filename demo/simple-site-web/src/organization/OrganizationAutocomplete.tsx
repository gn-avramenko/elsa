...
import { OrganizationAutocompleteSkeleton } from '@g/organization/OrganizationAutocompleteSkeleton';

function OrganizationAutocompleteFC(props: {
    element: OrganizationAutocompleteComponent;
}) {
...
export class OrganizationAutocompleteComponent extends OrganizationAutocompleteSkeleton {
    functionalComponent = OrganizationAutocompleteFC;
