...
import { ManagersListSkeleton } from '@g/manager/ManagersListSkeleton';

function ManagersListFC(props: { element: ManagersListComponent }) {
...
export class ManagersListComponent extends ManagersListSkeleton {
    functionalComponent = ManagersListFC;
