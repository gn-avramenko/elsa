...
public class CoreSerializableTypesConfigurator{
	...
	public void configure(){
...

		{
			...
			type.setId(id);
			type.setJavaQualifiedName("com.gridnine.elsa.common.model.domain.EntityReference");
			type.setReadonlyJavaQualifiedName("com.gridnine.elsa.common.model.domain._CachedEntityReference");
...

		{
			...
			type.setReadonlyJavaQualifiedName("com.gridnine.elsa.common.model.common.ReadOnlyArrayList");
...

		{
			...
			type.setReadonlyJavaQualifiedName("com.gridnine.elsa.common.model.common.ReadOnlyLinkedHashSet");
			type.setFinalField(true);
			var genererics_0 = new ArrayList<GenericDeclaration>();
			{
				var generic = new SingleGenericDeclaration();
...

		{
			...
			type.setReadonlyJavaQualifiedName("com.gridnine.elsa.common.model.common.ReadOnlyLinkedHashMap");
			type.setFinalField(true);
			var genererics_0 = new ArrayList<GenericDeclaration>();
			{
				var generic = new SingleGenericDeclaration();
