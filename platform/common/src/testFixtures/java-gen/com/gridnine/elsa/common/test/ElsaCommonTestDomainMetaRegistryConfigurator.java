...
package com.gridnine.elsa.common.test;
...
public class ElsaCommonTestDomainMetaRegistryConfigurator{
	...
	public void configure(){
		...
		{
			var enumDescription = new EnumDescription("com.gridnine.elsa.common.test.model.domain.TestEnum");
			{
			...
			smr.getEnums().put("com.gridnine.elsa.common.test.model.domain.TestEnum", enumDescription);
			dmr.getEnumsIds().add("com.gridnine.elsa.common.test.model.domain.TestEnum");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument");
			...
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument", entityDescription);
			dmr.getEntitiesIds().add("com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestDomainNestedDocumentImpl");
			entityDescription.getAttributes().put("extends", "com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument");
			{
				var propertyDescription = new PropertyDescription("value");
				propertyDescription.setTagName("string-property");
				entityDescription.getProperties().put("value", propertyDescription);
			}
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestDomainNestedDocumentImpl", entityDescription);
			dmr.getEntitiesIds().add("com.gridnine.elsa.common.test.model.domain.TestDomainNestedDocumentImpl");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestGroup");
			{
				var propertyDescription = new PropertyDescription("name");
				propertyDescription.setTagName("string-property");
				entityDescription.getProperties().put("name", propertyDescription);
			}
			{
				...
				propertyDescription.getAttributes().put("element-class-name", "com.gridnine.elsa.common.test.model.domain.TestItem");
				entityDescription.getProperties().put("items", propertyDescription);
			}
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestGroup", entityDescription);
			dmr.getEntitiesIds().add("com.gridnine.elsa.common.test.model.domain.TestGroup");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestItem");
			{
				var propertyDescription = new PropertyDescription("name");
				propertyDescription.setTagName("string-property");
				entityDescription.getProperties().put("name", propertyDescription);
			}
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestItem", entityDescription);
			dmr.getEntitiesIds().add("com.gridnine.elsa.common.test.model.domain.TestItem");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestDomainAsset");
			...
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestDomainAsset", entityDescription);
			dmr.getAssetsIds().add("com.gridnine.elsa.common.test.model.domain.TestDomainAsset");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestDomainDocument");
			entityDescription.getAttributes().put("cache-resolve", "true");
			entityDescription.getAttributes().put("caption-expression", "stringProperty");
			{
				var propertyDescription = new PropertyDescription("stringProperty");
			...
			}
			{
				...
				propertyDescription.getAttributes().put("class-name", "com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument");
			...
			}
			{
				...
				propertyDescription.getAttributes().put("class-name", "com.gridnine.elsa.common.test.model.domain.TestEnum");
			...
			}
			{
				...
				propertyDescription.getAttributes().put("class-name", "com.gridnine.elsa.common.test.model.domain.TestDomainDocument");
			...
			}
			{
				...
				propertyDescription.setTagName("entity-list");
				propertyDescription.getAttributes().put("element-class-name", "com.gridnine.elsa.common.test.model.domain.BaseTestDomainNestedDocument");
			...
			}
			{
				...
				propertyDescription.setTagName("entity-list");
				propertyDescription.getAttributes().put("element-class-name", "com.gridnine.elsa.common.test.model.domain.TestGroup");
			...
			}
			{
				...
				propertyDescription.getAttributes().put("element-class-name", "com.gridnine.elsa.common.test.model.domain.TestEnum");
			...
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestDomainDocument", entityDescription);
			dmr.getDocumentsIds().add("com.gridnine.elsa.common.test.model.domain.TestDomainDocument");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.common.test.model.domain.TestDomainDocumentProjection");
			entityDescription.getAttributes().put("document", "com.gridnine.elsa.common.test.model.domain.TestDomainDocument");
			...
			smr.getEntities().put("com.gridnine.elsa.common.test.model.domain.TestDomainDocumentProjection", entityDescription);
			dmr.getProjectionsIds().add("com.gridnine.elsa.common.test.model.domain.TestDomainDocumentProjection");
		}
	}
}