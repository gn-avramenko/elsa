...
public class JdbcEntityReferenceFieldHandlerFactory implements JdbcFieldHandlerFactory {

    @Override
    public JdbcFieldHandler createHandler(String entityId, String fieldName, boolean indexed) {
        return new JdbcEntityReferenceFieldHandler(entityId, fieldName, indexed);
    }
}
