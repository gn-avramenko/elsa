...
public class ElsaCommonCoreCustomMetaRegistryConfigurator{
	...
	public void configure(){
		...
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.common.BaseIdentity");
			...
			smr.getEntities().put("com.gridnine.elsa.core.model.common.BaseIdentity", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.common.BaseIdentity");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.domain.BaseAsset");
			entityDescription.getAttributes().put("abstract", "true");
			entityDescription.getAttributes().put("extends", "com.gridnine.elsa.core.model.common.BaseIdentity");
			{
				var propertyDescription = new PropertyDescription("versionInfo");
				propertyDescription.setTagName("entity-property");
				propertyDescription.getAttributes().put("class-name", "com.gridnine.elsa.core.model.domain.VersionInfo");
				entityDescription.getProperties().put("versionInfo", propertyDescription);
			}
			smr.getEntities().put("com.gridnine.elsa.core.model.domain.BaseAsset", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.domain.BaseAsset");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.domain.BaseProjection");
			entityDescription.getAttributes().put("abstract", "true");
			{
				var propertyDescription = new PropertyDescription("document");
				propertyDescription.setTagName("entity-reference-property");
				propertyDescription.getAttributes().put("class-name", "com.gridnine.elsa.core.model.domain.BaseDocument");
			...
			smr.getEntities().put("com.gridnine.elsa.core.model.domain.BaseProjection", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.domain.BaseProjection");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.common.L10nMessage");
			{
			...
			smr.getEntities().put("com.gridnine.elsa.core.model.common.L10nMessage", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.common.L10nMessage");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.domain.VersionInfo");
			{
			...
			smr.getEntities().put("com.gridnine.elsa.core.model.domain.VersionInfo", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.domain.VersionInfo");
		}
		{
			var entityDescription = new EntityDescription("com.gridnine.elsa.core.model.domain.BaseDocument");
			entityDescription.getAttributes().put("abstract", "true");
			entityDescription.getAttributes().put("extends", "com.gridnine.elsa.core.model.common.BaseIdentity");
			{
				var propertyDescription = new PropertyDescription("versionInfo");
			...
			smr.getEntities().put("com.gridnine.elsa.core.model.domain.BaseDocument", entityDescription);
			cmr.getEntitiesIds().add("com.gridnine.elsa.core.model.domain.BaseDocument");
		}
	}
}