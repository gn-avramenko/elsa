...
public class StandardRemotingParameters {
    ...
    public static ContextParameterId<RemotingSubscriptionDescription> SUBSCRIPTION_DESCRIPTION = ()->"SUBSCRIPTION_DESCRIPTION";

    public static ContextParameterId<RemotingGroupDescription> GROUP_DESCRIPTION = ()->"GROUP_DESCRIPTION";
