...
public class JdbcBooleanFieldHandler extends BaseJdbcSingleFieldHandler {

    public JdbcBooleanFieldHandler(String fieldName, boolean indexed) {
        super(fieldName, indexed, SqlTypeBooleanHandler.type);
    }
    @Override
    ...
    public Map<String, Pair<Object, String>> getSqlValues(Object value) throws Exception {
        return Collections.singletonMap(fieldName, new Pair<>(value, SqlTypeBooleanHandler.type));
    }

    @Override
    public Pair<Object, String> getSqlQueryValue(Object value) throws Exception {
        return new Pair<>(value, SqlTypeBooleanHandler.type);
    }
