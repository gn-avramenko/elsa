...
public record DatabaseStructureAnalysisResult(Set<String> tablesToDelete, Set<CreateTableData> tablesToCreate, Set<UpdateTableData> tablesToUpdate, Set<String> sequencesToDelete, Set<SequenceDescription> sequencesToCreate) {
