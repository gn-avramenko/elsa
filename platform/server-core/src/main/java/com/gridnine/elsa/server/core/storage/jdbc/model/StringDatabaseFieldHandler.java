...
public class StringDatabaseFieldHandler extends BaseDatabaseSingleFieldHandler{

    public StringDatabaseFieldHandler(String fieldName, boolean indexed) {
        super(fieldName, indexed, SqlType.STRING);
    }
    @Override
    ...
    public Map<String, Pair<Object, SqlType>> getSqlValues(Object value, EnumMapper enumMapper, ClassMapper classMapper, ReflectionFactory factory) throws Exception {
        return Collections.singletonMap(fieldName, Pair.of( value, SqlType.STRING));
    }
