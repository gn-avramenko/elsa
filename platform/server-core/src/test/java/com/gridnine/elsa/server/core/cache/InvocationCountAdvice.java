...
public class InvocationCountAdvice implements StorageAdvice {
    ...
    @Override
    public <D extends BaseDocument, I extends BaseSearchableProjection<D>, E extends FieldNameSupport & EqualitySupport> EntityReference<D> onFindUniqueDocumentReference(Class<I> projClass, E property, Object propertyValue, CallableWithExceptionAnd3Arguments<EntityReference<D>, Class<I>, E, Object> callback) throws Exception {
        findDocumentCount++;
        return callback.call(projClass, property, propertyValue);
    }

    @Override
    public <A extends BaseAsset, E extends FieldNameSupport & EqualitySupport> A onFindUniqueAsset(Class<A> cls, E property, Object propertyValue, boolean forModification, CallableWithExceptionAnd4Arguments<A, Class<A>, E, Object, Boolean> callbackObject) throws Exception {
        findAssetCount++;
